...
function main(){
    ...
    // Processing
    const perfectSquare = verify_number_four_digt_is_perfect_sqr(number)

    // Output
    if(number < 1000 || number > 9999){
        console.log('Número inválido')
    }else{
        console.log(`O número é um quadradado perfeito: ${perfectSquare}`)
    }
}

function verify_number_four_digt_is_perfect_sqr(num){
